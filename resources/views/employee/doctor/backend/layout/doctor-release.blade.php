                        ...
                        <div class="row" >
                            <div class="col-md-12">
                                ...
                                <p style="font-family: 'Gill Sans MT'; font-size: 20px; text-align: justify-all;">
                                    ...
                                    <strong>Lifesupport hospital</strong> from <strong>@php echo($notes->created_at) @endphp </strong>to <strong>@php echo($to = Carbon\Carbon::now()) @endphp </strong> on @php echo($notes->bed_type) @endphp bed number @php echo($notes->bed->bed_number) @endphp under <strong>doctor @php echo($notes->user->name) @endphp </strong>.
                                    <br> <br>
