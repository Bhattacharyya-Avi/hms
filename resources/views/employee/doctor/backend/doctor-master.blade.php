...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
	<div class="wrapper">
		@include('employee.doctor.backend.fixed_part.doc-sidebar')	
		<div class="main">
			@include('employee.doctor.backend.fixed_part.doc-hader')
			<main class="content">
				
			@yield('content')
			
			</main>
			@include('employee.doctor.backend.fixed_part.doc-footer')
		</div>
	</div>
