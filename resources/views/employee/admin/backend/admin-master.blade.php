...
<body data-theme="light" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
	<div class="wrapper">
		@include('employee.admin.backend.fixed_part.admin-sidebar')	
		<div class="main">
			@include('employee.admin.backend.fixed_part.admin-hader')
			<main class="content">
				
			@yield('content')
			
			</main>
			@include('employee.admin.backend.fixed_part.admin-footer')
		</div>
	</div>
