...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
	<div class="wrapper">
		@include('employee.accountant.backend.fixed-part.sidebar')	
		<div class="main">
			@include('employee.accountant.backend.fixed-part.hader')
			<main class="content">
				
			@yield('content')
			
			</main>
			@include('employee.accountant.backend.fixed-part.footer')
		</div>
	</div>
