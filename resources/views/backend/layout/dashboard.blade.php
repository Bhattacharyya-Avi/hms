                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                        <a href="{{url('/appointment')}}" class="btn btn-primary">click button</a> 
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                    <a href="/profile" class="btn btn-primary">click button</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                        <a href="/history" class="btn btn-primary">click button</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                    <a href="/payment" class="btn btn-primary">click button</a>
                                    </div>
                                </div>
                            </div>
                        </div>
