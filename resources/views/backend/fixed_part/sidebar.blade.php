		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item">
				...
				<ul id="auth" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
					<li class="sidebar-item"><a class="sidebar-link" href="/appointment">Book Appointment</a></li>
					<li class="sidebar-item"><a class="sidebar-link" href="/history">Appointment History</a></li>
